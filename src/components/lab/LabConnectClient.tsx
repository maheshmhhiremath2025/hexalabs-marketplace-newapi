...
export default function LabConnectClient({ purchaseId, courseId, status, vmPublicIP, requiresAzurePortal, sessionData }: LabConnectClientProps) {
    ...
    return (
        <div className="fixed inset-0 bg-slate-950 text-white font-mono flex flex-col">
            ...
            {/* Helpful Info Banner - Dismissible */}
            {showTipBanner && (
                <div className="bg-blue-900/30 border-b border-blue-700/50 px-4 py-2 flex items-center gap-2 text-sm text-blue-200 flex-shrink-0">
                    <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                    </svg>
                    <span className="flex-1">
                        <strong>Tip:</strong> If you see a Guacamole login page, please refresh the page or click "Reconnect" in the console menu.
                    </span>
                    <button
